# Voice and Craft Smells

Use these as diagnostic lenses, not rigid rules.
...
2. Preserve the emotional truth.
3. Preserve concrete scene and bodily detail.
4. Improve structure, flow, rhythm, and clarity.
5. Remove AI residue only when it weakens the prose.
...
### Abstract Drift
The paragraph moves from idea to idea without sensory contact.

Fix:
Add one concrete noun, one bodily cue, or one musical action.

## AI-tell policy

Do not ban words or punctuation mechanically.

Look for clusters:
- even cadence
- repeated rhetorical pattern
- over-significance
- generic abstraction
- too many polished reversals
- summary endings
- lack of situated speaker

A single em dash, abstract word, or spiritual phrase is not a failure.
A repeated pattern that flattens voice is a failure.
